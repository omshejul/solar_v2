    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mt-6">
        <div className="flex justify-center">
          <a 
            href="https://pvcheck.havells.com/login"
            target="_blank"
            rel="noopener noreferrer" 
            className="inline-flex bold items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors"
          >
